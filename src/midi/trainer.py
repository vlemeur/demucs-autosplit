...
MINOR_EXERCISE_VOICINGS: dict[str, dict[str, list[tuple[str, tuple[str, ...]]]]] = {
    ...
    "F": {
        "Type A": [
            ("Gm7(b5)", ("F4", "Bb4", "Db5", "G5")),
            ("C7(b9)", ("Bb4", "Db5", "E5", "G5")),
            ("Fm7", ("Eb4", "Ab4", "C5", "F5")),
        ],
        "Type B": [
            ("Gm7(b5)", ("Bb4", "Db5", "F5", "G5")),
            ("C7(b9)", ("E4", "Bb4", "Db5", "G5")),
            ("Fm7", ("Ab4", "C5", "Eb5", "F5")),
        ],
    },
    "Bb": {
        "Type A": [
            ("Cm7(b5)", ("Bb3", "Eb4", "Gb4", "C5")),
            ("F7(b9)", ("Eb4", "Gb4", "A4", "C5")),
            ("Bbm7", ("Ab3", "Db4", "F4", "Bb4")),
        ],
        "Type B": [
            ("Cm7(b5)", ("Eb4", "Gb4", "Bb4", "C5")),
            ("F7(b9)", ("A3", "Eb4", "Gb4", "C5")),
            ("Bbm7", ("Db4", "F4", "Ab4", "Bb4")),
        ],
    },
    "Eb": {
        "Type A": [
            ("Fm7(b5)", ("Eb3", "Ab3", "B3", "F4")),
            ("Bb7(b9)", ("Ab3", "B3", "D4", "F4")),
            ("Ebm7", ("Db3", "Gb3", "Bb3", "Eb4")),
        ],
        "Type B": [
            ("Fm7(b5)", ("Ab3", "B3", "Eb4", "F4")),
            ("Bb7(b9)", ("D3", "Ab3", "B3", "F4")),
            ("Ebm7", ("Gb3", "Bb3", "Db4", "Eb4")),
        ],
    },
    "Ab": {
        "Type A": [
            ("Bbm7(b5)", ("Ab3", "Db4", "E4", "Bb4")),
            ("Eb7(b9)", ("Db4", "E4", "G4", "Bb4")),
            ("Abm7", ("Gb3", "Cb4", "Eb4", "Ab4")),
        ],
        "Type B": [
            ("Bbm7(b5)", ("Db4", "E4", "Ab4", "Bb4")),
            ("Eb7(b9)", ("G3", "Db4", "E4", "Bb4")),
            ("Abm7", ("Cb4", "Eb4", "Gb4", "Ab4")),
        ],
    },
    "C#": {
        "Type A": [
            ("D#m7(b5)", ("C#4", "F#4", "A4", "D#5")),
            ("G#7(b9)", ("F#4", "A4", "C5", "D#5")),
            ("C#m7", ("B3", "E4", "G#4", "C#5")),
        ],
        "Type B": [
            ("D#m7(b5)", ("F#4", "A4", "C#5", "D#5")),
            ("G#7(b9)", ("C4", "F#4", "A4", "D#5")),
            ("C#m7", ("E4", "G#4", "B4", "C#5")),
        ],
    },
    "F#": {
        "Type A": [
            ("G#m7(b5)", ("F#3", "B3", "D4", "G#4")),
            ("C#7(b9)", ("B3", "D4", "F4", "G#4")),
            ("F#m7", ("E3", "A3", "C#4", "F#4")),
        ],
        "Type B": [
    ...
    "B": {
        "Type A": [
            ("C#m7(b5)", ("B3", "E4", "G4", "C#5")),
            ("F#7(b9)", ("E4", "G4", "A#4", "C#5")),
            ("Bm7", ("A3", "D4", "F#4", "B4")),
        ],
        "Type B": [
            ("C#m7(b5)", ("E4", "G4", "B4", "C#5")),
            ("F#7(b9)", ("A#3", "E4", "G4", "C#5")),
            ("Bm7", ("D4", "F#4", "A4", "B4")),
        ],
    },
    "E": {
        "Type A": [
            ("F#m7(b5)", ("E3", "A3", "C4", "F#4")),
            ("B7(b9)", ("A3", "C4", "D#4", "F#4")),
            ("Em7", ("D3", "G3", "B3", "E4")),
        ],
        "Type B": [
...
def build_minor_exercise(*, key: str, variant: str) -> TrainerExercise:
    voicings = [
        (symbol, _shift_notes_by_octave(notes, delta=-1))
        for symbol, notes in MINOR_EXERCISE_VOICINGS[key][variant]
    ]
    steps = tuple(
        TrainerStep(
            symbol=symbol,
...
def _shift_notes_by_octave(notes: tuple[str, ...], *, delta: int) -> tuple[str, ...]:
    shifted: list[str] = []
    for note_name in notes:
        base = note_name[:-1]
        octave = int(note_name[-1])
        shifted.append(f"{base}{octave + delta}")
